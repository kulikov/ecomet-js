...
(function() {
  ...
  define(["use!underscore", "use!sockjs"], function(_, SockJS) {
    ...
    Ecomet = (function() {
      ...
      Ecomet.prototype._eventHandlers = {};
      ...
      Ecomet.prototype.on = function(name, callback) {
        var _base, _ref;
      ...
      Ecomet.prototype.trigger = function(name, options) {
